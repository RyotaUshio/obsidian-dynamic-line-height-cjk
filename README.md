...
This [Obsidian.md](https://obsidian.md) plugin dynamically adjusts the height of each line (in Editing View) or paragraph (in Reading View) based on it contains CJK characters. This is useful because CJK (Chinese, Japanese, & Korean) characters typically require more line height than European alphabets.
